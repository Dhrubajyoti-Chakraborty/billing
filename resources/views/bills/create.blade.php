...
<div class="page-header">
    <div class="header-inner">
        ...
        <nav>
            <a href="{{ route('bills.create') }}" class="nav-link active">New Bill</a>
                ...
                <table id="itemTable">
                    ...
                    <tbody id="itemBody">
                        <tr class="item-row">
                            ...
                            <td><input type="number" name="price[]" min="0.01" step="0.01" required oninput="calcRow(this)"></td>
...
function calcRow(input) {
    ...
    const qty = tr.querySelector('input[name="quantity[]"]').value || 0;
    const price = tr.querySelector('input[name="price[]"]').value || 0;
...
function calcTotals() {
    ...
    const gst = document.getElementById('gstPercent').value || 0;
